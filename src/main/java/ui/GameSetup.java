...
public class GameSetup {
	...
	public GameSetup(GameView view, TurnView turnView) {
		this.gameView = view;
		this.gameView.chooseLanguage();
		int numPlayers = this.gameView.chooseNumPlayers();
		Deck deck = new Deck();
	...
	public TurnController getTurnController() {
		return this.gameController.getTurnController();
	}

	public TurnView getTurnView() {
		return this.gameController.getTurnView();
	}

	public Deck getDeck() {
		return this.gameController.getDeck();
	}
}
